from modelo.pension_calculator import *
def ejecutar_calculo_pension():
    try:
        datos = solicitar_datos_por_consola()
        calcular = PensionEstimada(*datos)
        resultado = calcular.calcular_pension()
        mostrar_resultado(*resultado)
    except (PensionEstimada.edad_negativa, PensionEstimada.saldo_negativo, PensionEstimada.rentabilidad_negativa, PensionEstimada.administracion_negativa, PensionEstimada.semanas_negativas, PensionEstimada.semanas_insuficientes, PensionEstimada.edad_insuficiente, PensionEstimada.sexo_invalido) as e:
        print("Error:", e)
